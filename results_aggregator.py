        ...
        for seed in seeds:
            ...
            if os.path.exists(filename):
                with open(filename) as csv_file:
                    ...
                    for row in data:
                        metrics.append(["MOFJSSP", instance, m, 2 * total_num_operations_per_instance[instance], solver_labels[solvers[i]], seed, metrics_labels[0], float(row[0])])
                    csv_file.close()
        ...
        for seed in seeds:
            ...
            if os.path.exists(filename):
                with open(filename) as csv_file:
                    data = csv.reader(csv_file, delimiter = ",")
                    for row in data:
                        metrics.append(["MOFJSSP", instance, m, 2 * total_num_operations_per_instance[instance], solver_labels[solvers[i]], seed, metrics_labels[1], float(row[0])])
                    csv_file.close()
        ...
        for seed in seeds:
            ...
            if os.path.exists(filename):
                with open(filename) as csv_file:
                    data = csv.reader(csv_file, delimiter = ",")
                    for row in data:
                        metrics.append(["MOFJSSP", instance, m, 2 * total_num_operations_per_instance[instance], solver_labels[solvers[i]], seed, metrics_labels[2], float(row[0])])
                    csv_file.close()
